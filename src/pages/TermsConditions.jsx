      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 font-sans">
        ...
        <div className="lg:col-span-1 hidden lg:block sticky top-28 self-start">
          <div className="bg-white rounded-none p-6 border border-slate-200 shadow-sm">
            <h3 className="font-bold text-gray-800 mb-4 text-xs uppercase tracking-wider">Document Index</h3>
        ...
        <div className="lg:col-span-3 space-y-8">
          <div className="bg-white rounded-none p-8 md:p-10 border border-slate-200 shadow-sm leading-relaxed text-slate-800">
            <p className="text-xs text-slate-400 mb-8 font-bold uppercase tracking-wider">Effective Date: May 19, 2026</p>
            ...
            <div className="space-y-12">
              {sections.map((sec, idx) => (
                <div key={idx} id={`terms-${idx}`} className="scroll-mt-28 space-y-4">
                  ...
                  <p className="text-slate-650 leading-relaxed text-sm md:text-base font-medium">{sec.content}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-12 p-6 rounded-none bg-slate-50 border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
              <div>
                ...
                <p className="text-sm text-slate-500 font-semibold">Contact our legal and operations team for any queries regarding learner contracts.</p>
              </div>
              <a 
                href="mailto:support@kelvornex.com" 
                className="bg-black hover:bg-transparent border-2 border-black text-white hover:text-black font-bold px-6 py-3.5 rounded-full transition-all shadow-md shadow-black/10 shrink-0 text-xs tracking-wider uppercase cursor-pointer"
              >
                Contact Support
              </a>
            </div>
